...
pub fn x403a5e(ctx: &mut Context) -> Cont {
    ...
    ctx.cpu.fpu.cmp = ctx
        ...
        .fpu
        .get(0)
        .partial_cmp(&(ctx.memory.read::<f32>(0x40c080u32) as f64));
    ctx.cpu.fpu.pop();
    // 00403a6b fnstsw ax
...
pub fn x403a98(ctx: &mut Context) -> Cont {
    ...
    ctx.cpu.fpu.cmp = ctx
        ...
        .fpu
        .get(0)
        .partial_cmp(&(ctx.memory.read::<f32>(0x40c084u32) as f64));
    ctx.cpu.fpu.pop();
    // 00403aa1 fnstsw ax
    ctx.cpu.regs.set_ax(ctx.cpu.fpu.status());
    // 00403aa3 sahf
...
pub fn x4045b8(ctx: &mut Context) -> Cont {
    ...
    ctx.cpu.fpu.cmp = ctx.cpu.fpu.get(0).partial_cmp(
        &(ctx
            .memory
...
pub fn x4053fc(ctx: &mut Context) -> Cont {
    ...
    ctx.cpu.fpu.cmp = ctx
        ...
        .fpu
        .get(0)
        .partial_cmp(&(ctx.memory.read::<f32>(0x40c1bcu32) as f64));
    ctx.cpu.fpu.pop();
    // 00405427 fnstsw ax
    ctx.cpu.regs.set_ax(ctx.cpu.fpu.status());
    // 00405429 sahf
