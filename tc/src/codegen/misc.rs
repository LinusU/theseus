...
impl<'a> CodeGen<'a> {
    pub fn codegen_misc(&mut self, instr: &iced_x86::Instruction) -> bool {
        ...
        match instr.mnemonic() {
            ...
            Ud0 | Ud1 | Pf2iw | Pdistib | Xstore | Xcryptcbc | Xcryptcfb | Xcryptctr
            | Xcryptecb | Xcryptofb | Montmul | Xsha1 | Xsha256 | Getsec | Loadall | Jmpe
            | Xsave | Xrstor | Xsaveopt | Xsaves | Xrstors | Xsavec | Rdrand | Rdseed | Rdpid
            | Clzero | Clwb | Pcommit | Wbnoinvd | Monitorx | Mwaitx | Tpause | Umonitor
            | Umwait | Cldemote | Rdpkru | Wrpkru | Vmgexit | Vmrun | Vmmcall | Vmload | Vmsave
            | Skinit | Stgi | Clgi | Invlpga | Invlpgb | Enqcmd | Enqcmds | Movdiri | Movdir64b
            | Serialize | Hreset | Clui | Stui | Testui | Uiret | Senduipi | Setssbsy
            | Clrssbsy | Incsspd | Incsspq | Rstorssp | Saveprevssp | Wrssd | Wrussd | Wrssq
            | Wrussq => {
